...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 $a_descr = $_POST['a_descript'];

 $queryInsert = "INSERT INTO listDeed (deed_descr) VALUES ('$a_descr')";
...
<body>
  ...
  <form id = "insertDeed" action="" method="" enctype ="multipart/form-data">
  ...
  <h3>Have some new ideas? Share it with the world!</h3>
  <p ><label></label><textarea type = "text" rows="5" cols="350" name = "a_descript" required></textarea></p>
...
//   // insert
   $("#insertDeed").submit(function(event) {
     event.preventDefault();
     console.log("button clicked");


     let form = $('#insertDeed')[0];
